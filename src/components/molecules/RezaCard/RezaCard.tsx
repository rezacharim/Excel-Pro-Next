const RezaCard = () => {
  return (
    <div className="w-full flex-1 rounded-lg shadow-xl relative overflow-hidden bg-[url('/images/person/reza-abedian.webp')] bg-cover bg-no-repeat bg-[center_20%] min-h-[240px]">
